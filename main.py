...
async def start(bot, message):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("☠️Join Channel☠️", url="https://t.me/teamcinderella")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await message.reply_photo(
        photo=random_image_url,
        caption="**HABIBI im 1st Automation PRESS HERE😹\n\n\nOR USE /Pw COMMAND TO EXTRACT🤭**.",
        quote=True,
...
async def pwwp_command(bot, message):
    ...
    THREADPOOL.submit(_run_async_in_thread, process_pwwp(bot, message, user_id))
    ...
    async with aiohttp.ClientSession(connector=CONNECTOR, loop=loop) as session:
        try:
            ...
            # ==========================================================
                ...
                selected_batch_name = f"{selected_batch_name}\nFormat:TODAY CLASS"
